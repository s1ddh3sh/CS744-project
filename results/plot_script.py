...
plt.title("get_popular Load Testing (Throughput)")
...
plt.title("get_popular Load Testing (Response Time)")
plt.xlabel("Load Level")
...
plt.figure(figsize=(8,5))
plt.plot(df['Threads'], df['Throughput'], marker='o')
plt.title("put_all Load Testing (Throughput)")
plt.xlabel("Load Level")
plt.ylabel("Throughput req/s")
plt.grid(True)
plt.tight_layout()
...
plt.figure(figsize=(8,5))
plt.plot(df['Threads'], df['Response Time'], marker='o', color='orange')
plt.title("put_all Load Testing (Response Time)")
plt.xlabel("Load Level")
plt.ylabel("Response Time (ms)")
plt.grid(True)
plt.tight_layout()
...
plt.figure(figsize=(8,5))
plt.plot(df['Threads'], df['DB util'], marker='o', color='green')
plt.title("put_all Mem Utilization")
plt.xlabel("Load Level")
plt.ylabel("DB Util (%)")
plt.grid(True)
plt.tight_layout()
